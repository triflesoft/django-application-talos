# Generated by Django 2.0.3 on 2018-05-09 08:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.CharField(default=talos.models._default_hostname, max_length=255)),
                ('modified_on', models.CharField(default=talos.models._default_hostname, max_length=255)),
                ('identifier', models.CharField(choices=[('email', 'Email'), ('phone', 'Phone'), ('undefined', 'Undefined')], default='undefined', editable=False, max_length=255)),
        ...
        migrations.AlterUniqueTogether(
            name='role',
            unique_together={('directory', 'code'), ('directory', 'name')},
        ),
        migrations.AlterUniqueTogether(
            name='principalrolemembership',
        ...
        migrations.AlterUniqueTogether(
            name='objectaction',
            unique_together={('content_type', 'action'), ('application', 'model', 'action')},
        ),
        migrations.AlterUniqueTogether(
            name='basicidentitydirectoryobjectpermission',
            unique_together={('role', 'action', 'target')},
