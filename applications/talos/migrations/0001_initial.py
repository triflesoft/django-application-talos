# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-15 00:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.CharField(default='DREAM', max_length=255)),
                ('modified_on', models.CharField(default='DREAM', max_length=255)),
        ...
        migrations.AlterUniqueTogether(
            name='tokencredentialdirectoryobjectpermission',
            unique_together=set([('role', 'action', 'target')]),
        ),
        migrations.AlterIndexTogether(
            name='tokencredentialdirectoryobjectpermission',
            index_together=set([('target', 'role', 'action'), ('role', 'target', 'action'), ('target', 'action', 'role')]),
        ),
        migrations.AlterUniqueTogether(
            name='tokencredential',
            unique_together=set([('directory', 'public_value'), ('directory', 'principal')]),
        ),
        migrations.AlterUniqueTogether(
            name='subnetcredentialdirectoryobjectpermission',
            unique_together=set([('role', 'action', 'target')]),
        ...
        migrations.AlterUniqueTogether(
            name='subnetcredential',
            unique_together=set([('directory', 'address')]),
        ),
        migrations.AlterUniqueTogether(
            name='roleprivilegepermissionrevoked',
            unique_together=set([('role', 'privilege')]),
        ),
        migrations.AlterIndexTogether(
            name='roleprivilegepermissionrevoked',
            index_together=set([('privilege', 'role')]),
        ),
        migrations.AlterUniqueTogether(
            name='roleprivilegepermissiongranted',
            unique_together=set([('role', 'privilege')]),
        ...
        migrations.AlterUniqueTogether(
            name='rolemodelactionpermissionrevoked',
            unique_together=set([('role', 'model_action')]),
        ),
        migrations.AlterIndexTogether(
            name='rolemodelactionpermissionrevoked',
            index_together=set([('model_action', 'role')]),
        ),
        migrations.AlterUniqueTogether(
            name='rolemodelactionpermissiongranted',
            unique_together=set([('role', 'model_action')]),
        ...
        migrations.AlterUniqueTogether(
            name='roledirectoryrequiredevidence',
            unique_together=set([('directory', 'evidence')]),
        ),
        migrations.AlterUniqueTogether(
            name='roledirectoryoption',
        ...
        migrations.AlterUniqueTogether(
            name='role',
            unique_together=set([('directory', 'name'), ('directory', 'code')]),
        ),
        migrations.AlterUniqueTogether(
            name='principalrolemembership',
            unique_together=set([('principal', 'role')]),
        ),
        migrations.AlterIndexTogether(
            name='principalrolemembership',
            index_together=set([('role', 'principal')]),
        ),
        migrations.AlterUniqueTogether(
            name='principalobjectpermission',
            unique_together=set([('role', 'action', 'target')]),
        ...
        migrations.AlterUniqueTogether(
            name='onetimepasswordcredential',
            unique_together=set([('directory', 'principal')]),
        ),
        migrations.AlterUniqueTogether(
            name='objectaction',
            unique_together=set([('content_type', 'action'), ('application', 'model', 'action')]),
        ),
        migrations.AlterUniqueTogether(
            name='basicidentitydirectoryobjectpermission',
            unique_together=set([('role', 'action', 'target')]),
        ...
        migrations.AlterUniqueTogether(
            name='basicidentity',
            unique_together=set([('directory', 'username')]),
        ),
        migrations.AlterUniqueTogether(
            name='basiccredentialdirectoryobjectpermission',
            unique_together=set([('role', 'action', 'target')]),
