...
class BasicIdentityDirectory(AbstractIdentityDirectory):
    ...
    OTP_credential_directory = models.ForeignKey('OneTimePasswordCredentialDirectory', null=True, blank=True, related_name='otp_identity_directories', on_delete=models.CASCADE)
