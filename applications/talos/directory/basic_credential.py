...
class Ldap(object):
    ...
    def verify_credentials(self, username, credentials):
        ...
        try:
            ldap_connection.check_credentials(username, password)
            return True
        except:
            pass

        logger.debug('TALOS: LDAP credential verification failed for "%s".', username)
